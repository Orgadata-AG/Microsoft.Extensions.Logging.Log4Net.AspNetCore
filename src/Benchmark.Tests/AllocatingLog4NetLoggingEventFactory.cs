...
namespace Microsoft.Extensions.Logging
{
    ...
    public sealed class AllocatingLog4NetLoggingEventFactory
    {
        /// <inheritdoc/>
        public LoggingEvent CreateLoggingEvent<TState>(AllocatingMessageCandidate<TState> messageCandidate, log4net.Core.ILogger logger, Log4NetProviderOptions options, IExternalScopeProvider scopeProvider)
        {
